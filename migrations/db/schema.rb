...
ActiveRecord::Schema.define(version: 20161110105832) do
  ...
  create_table "agreement", force: :cascade do |t|
    t.text "description"
  end
  ...
  create_table "catetory_url", force: :cascade do |t|
    t.integer  "channel_id"
    t.text     "url_key"
    t.text     "type"
    t.text     "ref_id"
  ...
  create_table "channel_region_assoc", force: :cascade do |t|
    t.integer  "channel_id"
    t.integer  "city_id"
    t.jsonb    "detail"
  ...
  create_table "crawled_banner", force: :cascade do |t|
  ...
  add_index "crawled_products", ["crawler_log_id"], name: "ix_crawler_log_id", using: :btree
  ...
  create_table "crawled_promotions", force: :cascade do |t|
    ...
    t.integer  "crawler_log_id"
    t.boolean  "is_active"
    t.string   "offer_title",    limit: 500
    t.text     "img_url"
    t.text     "product_url"
    t.float    "selling_price"
  end

  add_index "crawled_promotions", ["crawl_date", "is_active"], name: "crawled_promotions_crawl_date_is_active_idx", using: :btree
...
#   Unknown type 'time with time zone' for column 'from_date'
  ...
  create_table "ct", id: false, force: :cascade do |t|
    t.integer "id",        default: "nextval('ct_id_seq'::regclass)", null: false
    t.text    "rowid"
    t.text    "attribute"
    t.text    "value"
  end
  ...
  create_table "existing_ids", id: false, force: :cascade do |t|
    t.integer "array_agg", array: true
  end

  create_table "grofers_products_keywords", force: :cascade do |t|
    t.integer "product_id"
  ...
  create_table "group_category_mapping", force: :cascade do |t|
    t.integer "group_id"
    t.integer "category_id"
  end

  create_table "group_category_url_mapping", force: :cascade do |t|
    t.integer "group_id"
    t.integer "category_id"
    t.integer "category_url_id"
  end
  ...
  add_index "group_product_mapping", ["group_id", "is_competitor", "my_product_id"], name: "group_product_mapping_group_id_is_competitor_my_product_id_idx", using: :btree
  ...
  create_table "group_widget_mapping", force: :cascade do |t|
    t.integer "group_id"
    t.integer "widget_id"
    t.integer "sequence"
  end
...
#   Unknown type 'time with time zone' for column 'creation_time'
  ...
  create_table "user_menu", force: :cascade do |t|
    t.integer "user_id"
    t.integer "menu_id"
    t.integer "sequence"
  end

  add_index "user_menu", ["menu_id", "user_id"], name: "user_id_menu_id", unique: true, using: :btree
  ...
  add_foreign_key "catetory_url", "channels", name: "catetory_url_id_fkey"
  ...
  add_foreign_key "crawled_banner", "categories", name: "crawled_banner_category_id_fkey"
  add_foreign_key "crawled_banner", "catetory_url", column: "category_url_id", name: "crawled_banner_category_url_id_fkey"
  add_foreign_key "crawled_banner", "channels", name: "crawled_banner_channel_id_fkey"
  add_foreign_key "crawled_banner", "city", name: "crawled_banner_city_id_fkey"
  ...
  add_foreign_key "crawled_products", "city", name: "crawled_products_city_id_fkey"
  ...
  add_foreign_key "crawler_log", "channels", name: "crawler_log_channel_id_fkey"
  ...
  add_foreign_key "grofers_products_keywords", "products", name: "grofers_products_keywords_product_id_fkey"
  ...
  add_foreign_key "group_category_mapping", "categories", name: "group_category_mapping_categoty_id_fkey"
  add_foreign_key "group_category_mapping", "groups", name: "group_brand_mapping_group_id_fkey"
  add_foreign_key "group_category_url_mapping", "categories", name: "group_category_url_mapping_category_id_fkey"
  add_foreign_key "group_category_url_mapping", "catetory_url", column: "category_url_id", name: "group_category_url_mapping_category_url_id_fkey"
  add_foreign_key "group_category_url_mapping", "groups", name: "group_category_url_mapping_group_id_fkey"
  ...
  add_foreign_key "group_widget_mapping", "groups", name: "group_widget_mapping_group_id_fkey"
  add_foreign_key "group_widget_mapping", "widgets", name: "group_widget_mapping_widget_id_fkey"
